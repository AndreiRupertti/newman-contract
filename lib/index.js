...
const collection_1 = __importDefault(require("./core/contract/collection"));
const definition_1 = __importDefault(require("./core/contract/definition"));
const schema = {
    definitions: {},
...
const navRequests = [
    definition_1.default({
        method: "GET",
        name: "Test 1 ",
        endpoint: "http://dnd5eapi.co/api/spells/acid-arrow",
        schema,
    }),
];
const collection = collection_1.default({ name: "My Contract Collection" });
