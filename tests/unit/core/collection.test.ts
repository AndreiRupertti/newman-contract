...
import { validPostmanDummyPreRequestEvent, validPostmanRequestItemGET } from "@tests/mocks/postman_request";
...
describe("Contract Collection", () => {
    ...
    describe("When creating a new contract collection", () => {
        ...
        it("should return an instace of base collection", () => {
            const contractCollection = ContractCollection(({ name: "Contract collection", fromPattern: "*" }));
