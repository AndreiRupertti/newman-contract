...
export type IVariablesMangerPM = Pick<
  PostmanTypes.VariableScope,
  "has" | "get" | "toObject" | "set"
>;
...
export type PostmanURL = Overwrite<
  PostmanTypes.UrlDefinition,
  { query?: ISimpleObject[] }
>;
...
export type ContractCollectionBuilder = (
  options: IContractCollectionOptions
) => PostmanTypes.CollectionDefinition;
export type ContractDefinitionBuilder = (
  options: IContractDefinition
) => IRequestDefinition<IContractGlobals>;
